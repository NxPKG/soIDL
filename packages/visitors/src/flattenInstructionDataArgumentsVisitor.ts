import { SOIDL_ERROR__VISITORS__CANNOT_FLATTEN_STRUCT_WITH_CONFLICTING_ATTRIBUTES, SoidlError } from '@soidl/errors';
import {
    assertIsNode,
    camelCase,
...
export const flattenInstructionArguments = (
    ...
    if (hasConflictingNames) {
        throw new SoidlError(SOIDL_ERROR__VISITORS__CANNOT_FLATTEN_STRUCT_WITH_CONFLICTING_ATTRIBUTES, {
