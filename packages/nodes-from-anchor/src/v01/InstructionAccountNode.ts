        ...
        if (!seedsWithNestedPaths) {
                    ...
                    switch (kind) {
                        ...
                        case 'account': {
                            ...
                            if (path.length === 1) {
                                ...
                                if (!accountNode) {
                                    throw new SoidlError(SOIDL_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING, { kind });
                                }
                                ...
                                if (!fieldNode) {
                                    throw new SoidlError(SOIDL_ERROR__ANCHOR__TYPE_PATH_MISSING, {
                        ...
                        case 'arg': {
                            ...
                            if (!argumentNode) {
                                throw new SoidlError(SOIDL_ERROR__ANCHOR__ARGUMENT_TYPE_MISSING, { name: seed.path });
                            }
                        ...
                        default:
                            throw new SoidlError(SOIDL_ERROR__ANCHOR__SEED_KIND_UNIMPLEMENTED, { kind });
                    }
                },
            ...
            if (idl.pda.program !== undefined) {
                ...
                switch (kind) {
                    ...
                    default: {
                        throw new SoidlError(SOIDL_ERROR__ANCHOR__PROGRAM_ID_KIND_UNIMPLEMENTED, { kind });
                    }
                }
            }
