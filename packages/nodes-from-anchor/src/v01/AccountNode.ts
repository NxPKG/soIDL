import { SOIDL_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING, SoidlError } from '@soidl/errors';
import {
    AccountNode,
    accountNode,
    assertIsNode,
...
export function accountNodeFromAnchorV01(idl: IdlV01Account, types: IdlV01TypeDef[]): AccountNode {
    ...
    if (!type) {
        throw new SoidlError(SOIDL_ERROR__ANCHOR__ACCOUNT_TYPE_MISSING, { name: idl.name });
    }
