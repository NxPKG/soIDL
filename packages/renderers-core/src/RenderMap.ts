import { SOIDL_ERROR__VISITORS__RENDER_MAP_KEY_NOT_FOUND, SoidlError } from '@soidl/errors';
...
export class RenderMap {
    ...
    get(key: string): string {
        ...
        if (value === undefined) {
            throw new SoidlError(SOIDL_ERROR__VISITORS__RENDER_MAP_KEY_NOT_FOUND, { key });
        }
        return value;
    }
