            ...
            case 'pdaValueNode':
                ...
                seeds.forEach(seed => {
                    ...
                    if (dependency.resolvedIsOptional) {
                        throw new SoidlError(SOIDL_ERROR__VISITORS__CANNOT_USE_OPTIONAL_ACCOUNT_AS_PDA_SEED_VALUE, {
        ...
        dependencies.forEach(dependency => {
            ...
            if (isNode(dependency, 'accountValueNode')) {
                ...
                if (!dependencyAccount) {
                    throw new SoidlError(SOIDL_ERROR__VISITORS__INVALID_INSTRUCTION_DEFAULT_VALUE_DEPENDENCY, {
                        dependency,
