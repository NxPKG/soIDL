import { SOIDL_ERROR__RENDERERS__UNSUPPORTED_NODE, SoidlError } from '@soidl/errors';
import {
    arrayTypeNode,
    CountNode,
    definedTypeNode,
...
import { extendVisitor, mergeVisitor, pipe, visit } from '@soidl/visitors-core';
        ...
        v =>
            extendVisitor(v, {
                ...
                visitRemainderOptionType(node) {
                    throw new SoidlError(SOIDL_ERROR__RENDERERS__UNSUPPORTED_NODE, { kind: node.kind, node });
                },
